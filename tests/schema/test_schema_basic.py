...
def test_is_token_valid_str_no_commas_or_spaces():
    schema = Schema.new(
        columns=[
            Column.string(
                "username", is_nullable=False, has_commas=False, has_spaces=False
            )
        ]
    )
...
def test_is_token_valid_str_with_commas_and_spaces():
    schema = Schema.new(
        columns=[
            Column.string(
                "address", is_nullable=False, has_commas=True, has_spaces=True
            )
        ]
    )
...
def test_is_token_valid_nullable_field():
    schema = Schema.new(
        columns=[
            Column.string(
                "middle_name", is_nullable=True, has_commas=False, has_spaces=False
            )
        ]
    )
...
def test_is_token_valid_non_nullable_field():
    schema = Schema.new(
        columns=[
            Column.string(
                "last_name", is_nullable=False, has_commas=False, has_spaces=False
            )
        ]
    )
...
def test_nullable_int():
    schema = Schema.new(
        columns=[
            Column.numeric(
                "score", is_nullable=True, has_commas=False, has_spaces=False
            )
        ]
    )
