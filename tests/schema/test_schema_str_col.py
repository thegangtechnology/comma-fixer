...
def schema() -> Schema:
    ...
    schema.add_str_column("str_space_comma", is_nullable=False, has_commas=True, has_spaces=True)
    schema.add_str_column("str_space", is_nullable=False, has_commas=False, has_spaces=True)
    schema.add_str_column("str_comma", is_nullable=False, has_commas=True, has_spaces=False)
    schema.add_str_column("str_no_space_no_comma", is_nullable=False, has_commas=False, has_spaces=False)
    schema.add_str_column("str_null_space_comma", is_nullable=True, has_commas=True, has_spaces=True)
    return schema
